...
|--------|-----|------|---------|-----------|
| PROJ-123 | P0 | Bug | <summary> | <why in-scope — root cause hypothesis or impact> |
...
|--------|-----|------|---------|--------------|----------------------|
| PROJ-456 | P3 | Copy | <summary> | <reason> | yes/no |
...
|--------|-----|---------|-----------------|
| PROJ-789 | P1 | <summary> | <one-line question — actual posted text> |
...
|--------|--------|--------------|
| PROJ-101 | PROJ-99 | Linked + closed via transition |
...
- Notes: <optional user notes; e.g., "PROJ-456 promoted to in-scope">
